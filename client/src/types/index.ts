...
export type Order={id:string;userId:string;groupId:string;sourceId:string;colorId:string;colorName?:string;clientId?:string;productId?:string;productIds?:string[];productNames?:string[];productItems?:OrderProductItem[];title:string;customer:string;dueDate:string;value:number;status:OrderStatus;observation:string;createdAt:string;updatedAt:string;lastEditedById?:string;lastEditedByName?:string};
